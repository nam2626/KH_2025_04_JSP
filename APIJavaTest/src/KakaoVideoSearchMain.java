...
public class KakaoVideoSearchMain {
	private static String REST_API_KEY = "d77c810e173c3afbf300da53d245b731";
	
	public static String callKakaoAPI(String searchText) {
		String responseBody = "";
//		1. URL 셋팅
		String apiURL = "https://dapi.kakao.com/v2/search/vclip";
		try {
